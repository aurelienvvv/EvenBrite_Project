class Event < ApplicationRecord
  ...
  validates :duration, presence: true, numericality: { only_integer: true },if: :modulo_5
  #La durée doit être un multiple de 5

  validates :title, presence: true, length: {in: 5..140}
  #Le titre à entre 5 et 140 caractères

  validates :description, presence: true, length: {in: 20..1000}
  #La description à entre 20 et 1000 caractères

  validates :price, presence: true,numericality: { only_integer: true }, :inclusion => 1..1000
  #Le prix doit être un integer entre 1 et 1000
